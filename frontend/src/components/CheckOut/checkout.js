          ...
          <div className="tab-content">
            ...
            <div id="credit-card" className="tab-pane fade show active pt-3">
              <form role="form" onsubmit="event.preventDefault()">
                ...
                <div className="card-footer"> <Link to='/homescreen'>  <button  onClick={()  => alert('Payment Successfully,Thank you!')}   type="button" className="subscribe btn btn-primary btn-block shadow-sm"> Confirm Payment </button></Link>
                </div></form>
            </div> {/* End */}
            {/* Paypal info */}
